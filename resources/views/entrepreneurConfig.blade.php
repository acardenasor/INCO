    ...
    <div class="d-flex flex-column">
      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          ...
          <li><a href="entrepreneurConfig" class="nav-link scrollto active"><i class="bx bx-stats"></i> <span>Setting</span></a></li>
        </ul>
      </nav><!-- .nav-menu -->
    </div>
  </header><!-- End Header -->
      ...
      <div class="container">
        ...
        <div class="section-title">
          ...
          <div class="col-lg-12 d-md-flex align-items-md-stretch" class="form-group">
            <label for="exampleFormControlFile1">¿Quiénes somos?</label>
          </div>
          <div class="col-lg-12 d-md-flex align-items-md-stretch" class="form-group">
