  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          <li><a href="profileEntrepreneur" class="nav-link scrollto"><i class="bx bx-user"></i> <span>Profile</span></a></li>
          <li><a href="entrepreneurCreate" class="nav-link scrollto active"><i class="bx bx-plus"></i> <span>Create</span></a></li>
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Create an entrepreneur</h2>
          <div class="col-lg-12 d-md-flex align-items-md-stretch" class="form-group">
            <label for="exampleFormControlFile1">Name</label><br>
          </div>
          <div class="col-lg-12 d-md-flex align-items-md-stretch" class="form-group">
          ...
          <br><div class="col-lg-12 d-md-flex align-items-md-stretch" class="form-group">
